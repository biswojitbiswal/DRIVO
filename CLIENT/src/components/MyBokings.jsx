            ...
            return <div className="booking-card" key={index}>
              <div className="vehicle-info">
                  ...
                  <div className="vehicle-details">
                      ...
                      <p>Seats: {booking.bookedVehicle.seats}</p>
              ...
              <div className='booking-btns'>
                <p className={booking.status === 'Completed' ? "status-badge" : "incomplete-badge"}>{booking.status}</p>
                {
                  booking.status === 'Completed' ? " " : (
                    <button className="submit-btn cancel-btn">Cancel</button>
